...
class Testconnectors134043ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS134043_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS134043_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS134043"
